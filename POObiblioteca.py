...
a=Libro(1,33,"libro de la vida","un libro que explica la vida","filosofía","intro...etc")
b=Libro(1,105,"libro de la muerte","un libro que explica la muerte","filosofía","intro...etc")
c=Libro(1,355,"libro de la biología","un libro que habla de biología básica","biología","intro...etc")
